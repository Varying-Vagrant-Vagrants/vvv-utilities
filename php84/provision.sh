...
apt_package_install_list=(
  ...
  # PHP
  #
  # Our base packages for php8.4. As long as php8.4-fpm and php8.4-cli are
  # installed, there is no need to install the general php8.4 package, which
...
configure() {
  ...
  cp -f "${DIR}/upstream.conf" "/etc/nginx/upstreams/php84.conf"
  echo " * Copied ${DIR}/upstream.conf              to /etc/nginx/upstreams/php84.conf"
