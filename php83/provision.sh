...
apt_package_install_list=(
  ...
  # PHP
  #
  # Our base packages for php8.3. As long as php8.3-fpm and php8.3-cli are
  # installed, there is no need to install the general php8.3 package, which
...
configure() {
  ...
  cp -f "${DIR}/upstream.conf" "/etc/nginx/upstreams/php83.conf"
  echo " * Copied ${DIR}/upstream.conf              to /etc/nginx/upstreams/php83.conf"
