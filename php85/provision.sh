...
apt_package_install_list=(
  ...
  # PHP
  #
  # Our base packages for php8.5. As long as php8.5-fpm and php8.5-cli are
  # installed, there is no need to install the general php8.5 package, which
...
configure() {
  ...
  cp -f "${DIR}/upstream.conf" "/etc/nginx/upstreams/php85.conf"
  echo " * Copied ${DIR}/upstream.conf              to /etc/nginx/upstreams/php85.conf"
