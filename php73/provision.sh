...
configure() {
  ...
  cp "${DIR}/php7.3-www.conf" "/etc/php/7.3/fpm/pool.d/www.conf"
  cp "${DIR}/php7.3-custom.ini" "/etc/php/7.3/fpm/conf.d/php-custom.ini"
  cp "/srv/config/php-config/opcache.ini" "/etc/php/7.3/fpm/conf.d/opcache.ini"
  cp "/srv/config/php-config/xdebug.ini" "/etc/php/7.3/mods-available/xdebug.ini"
  ...
  if [[ -e /srv/config/php-config/mailhog.ini ]]; then
    cp "/srv/config/php-config/mailhog.ini" "/etc/php/7.3/mods-available/mailhog.ini"
